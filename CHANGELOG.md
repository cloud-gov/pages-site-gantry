...
- component scss causing transport timeout
- formatting lint
...
- use css classes
- fix lint
- Remove unecessary gap and padding since grid-gap class handles that for you
- fix linting
- fix formatting
- fix icon class
- add external icon to dropdown menu when is a external icon
- match collection schema
- fix label and data type
- fix formatting
- add external link icon when external link is provided
- clean up link logic
- adjust for changed schema
- remove extra space
- add rich text to home page
...
- Refactor site theming styles config
- Update tests to account for astro v6 test config to node
- Update README
- Upgrade astro to v6
