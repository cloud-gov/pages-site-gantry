...
import { FILTERS_CONFIG, UNSPECIFIED_FILTER_VALUE } from "@/utilities/filter";
import { getElementFiltersData } from "@/utilities/filter/filtersData.ts";
...
describe("Filters Utility, getFiltersSlugMetaData", () => {
  it("creates filters metadata for a slug", () => {
    ...
    collectionItem = { tags: [], yearTag: null, publishedAt: "2025" };
    ...
    collectionName = "events";
    collectionItem = { tags: [], yearTag: "2025", publishedAt: "2025" };
    slug = "virtual-qa-session-unlocking-industry-insights";
    expect(
      getFiltersSlugMetaData(collectionName, collectionItem, slug),
    ).toEqual({
